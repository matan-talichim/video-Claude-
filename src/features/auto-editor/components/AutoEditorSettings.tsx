    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs text-text-muted">
            (הערכה: מספיק חומר ל-{maxVideos} סרטונים)
          </span>
        </div>
      ...
      <div className="flex items-center gap-3 pt-2">
        <button
          ...
          className="flex items-center gap-2 px-6 py-3 bg-gradient-to-l from-accent-purple to-purple-600 hover:from-accent-purple/90 hover:to-purple-600/90 rounded-xl text-sm font-bold transition-all shadow-lg shadow-accent-purple/25 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          <Sparkles size={18} />
          התחל עריכה אוטומטית
        </button>
